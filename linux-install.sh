...
curl -L -O -f -m 120 --connect-timeout 5 --retry 5 --retry-connrefused --retry-max-time 60 --no-progress-meter https://github.com/clojure/brew-install/releases/download/1.12.4.1602/clojure-tools-1.12.4.1602.tar.gz
echo "07d95dee818455ca08fd025bfd204718085223b135bdcd4b5d0039b1cc6f92a3  clojure-tools-1.12.4.1602.tar.gz" | sha256sum -c | grep "^clojure-tools-1.12.4.1602.tar.gz: OK$"
tar xzf clojure-tools-1.12.4.1602.tar.gz
...
install -m644 clojure-tools/clojure-tools-1.12.4.1602.jar "$clojure_lib_dir/libexec/clojure-tools-1.12.4.1602.jar"
...
rm -rf clojure-tools
rm -rf clojure-tools-1.12.4.1602.tar.gz
